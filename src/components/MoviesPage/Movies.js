...
export default function Movies() {
    ...
    return (
        ...
        <div>
            ...
            <div>
                <a href="#start"><i></i></a>
                <img className={'image'} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYmoxMIfD17ec4sFJkleK4K_lB4QA6MZBRU3mkzNiRjBYbvKRr6SLZCuffw72GUjSk1Fo&usqp=CAU" alt=""/>
            </div>
        </div>
    );
